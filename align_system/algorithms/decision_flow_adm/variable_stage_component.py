...
class VariablesStageComponent(ADMComponent):
    def __init__(
        self,
    ...
    def run(self, scenario_state, choices, **kwargs):
        """Extract variables from task and choices"""
        ...
        prompt = call_with_coerced_args(
            ...
            {'scenario_description': scenario_description, 'choices': choices},
        )
        log.info(prompt)
            ...
            try:
                ...
                if attempt < self.max_json_retries - 1:
                    ...
                    raise SceneSkipException(
                        ...
                        component_name="VariablesStageComponent",
