...
from align_system.prompt_engineering.outlines_prompts import (
    ...
    comparative_kdma_score_prediction_prompt_no_reasoning,
    comparative_kdma_score_prediction_json_schema_no_reasoning,
...
class OutlinesTransformersComparativeRegressionADM(OutlinesTransformersADM):
    ...
    def sample_kdma_score_predictions(self,
        ...
        if "number" in incontext_settings and incontext_settings["number"] > 0:
            use_icl = True
            icl_example_generator = incontext_utils.ComparativeRegressionNoReasoningIncontextExampleGenerator(incontext_settings,
                                                                                                   target_kdmas)
        ...
        for sample_idx in range(num_samples):
            ...
            for target_kdma in target_kdmas:
                ...
                if use_icl:
                    ...
                    prompt_to_match = comparative_kdma_score_prediction_prompt_no_reasoning(scenario_description,
                                                                                    no_outcome_predictions,
                                                                                    target_kdma['name'])
                    selected_icl_examples = icl_example_generator.select_icl_examples(
                        sys_kdma_name=target_kdma['kdma'],
                ...
                predict_kdma_prompt = comparative_kdma_score_prediction_prompt_no_reasoning(scenario_description,
        ...
        score_schema = comparative_kdma_score_prediction_json_schema_no_reasoning(choices, target_kdma['factor'])
