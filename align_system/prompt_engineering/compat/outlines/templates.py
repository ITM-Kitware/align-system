# COMPATIBILITY NOTICE: This file copied from version 0.2.1 of
# outlines (https://github.com/dottxt-ai/outlines/blob/0.2.1/outlines/templates.py),
# as we still make heavy use of the outlines.prompt
# decorator.  Future prompt setups should use Template.from_string or
# Template.from_file methods recommended in newer outlines versions.
